...
for (iteration in 0:i) {
  ...
  sink("../validation_results/leave_10per_out_folding.txt", append=TRUE)
  print("\newentry", quote=FALSE)
  print(iteration, quote=FALSE)
  print("removed complexes: ", quote=FALSE)
  print(removed_subset, quote=FALSE)
  print("Length of new dataset: ", quote=FALSE)
  print(length(filtered_data$cplx), quote=FALSE)
  print("R_sq ranking: ", quote=FALSE)
  print(delta_r_sq_filtered(bestmodel1), quote=FALSE)
  print(summary(lm(bestmodel1)), quote=FALSE)
  sink()
}